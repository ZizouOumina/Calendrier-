...
{
  /* le 14 septembre, lundi = « Haut lourd » : 10 exercices depuis le 25 septembre (les relevés de jambes
     suspendus sont revenus en fin de séance ; plus de curl inversé) ; les clés sont « <type>-<index> » */
