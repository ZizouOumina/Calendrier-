...
- `programme-alimentation.md`, `programme-sport.md` — copies de référence du plan alimentaire (prises, rotation, boucle poids → calories, courses) et du programme de sport v2 (quatre séances, abdos à chaque séance, cou en isométrie le lundi et le jeudi, trapèzes le jeudi et le samedi, échauffements, progression, lest).
