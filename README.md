...
- `cinq-ans-en-public.html` — le plan de marque personnelle, année par année, de la première année de dentaire au diplôme : la thèse (une archive, pas une audience), les trois murs (publicité sanitaire, e-professionnalisme, cloison avec le dropshipping), l'architecture des comptes, la bascule de langue, les quatre piliers, vingt idées de vidéos écrites d'avance, la semaine de production, les métriques et les sources. Page autonome, publiée aussi en Artifact.
