...
for(const [nom, quand, attendu] of [['lundi (veille dim. 21:00, lever 05:30)',LUNDI,'8 h 30'], ['samedi (veille ven. 21:35, lever 06:30 : le sport du samedi passe le soir)',SAMEDI,'8 h 55'], ['dimanche (veille sam. 21:00)',DIMANCHE,'9 h 30']]){
  const { ctx, fr } = await ouvrir(quand);
