...
- Je révise avec Anki (deux blocs le matin, 07:20 et 08:20), puis **« Étudier en avance » de 09:20 à 11:20** — un tema que je n'ai pas encore vu en cours — et **« Question ouverte ou autre » à 11:20** (lundi, mardi, jeudi). Le soir, **« Clore le cours du jour » à 20:30** (18:00 le mardi), vingt minutes par cours, pas davantage. Le mercredi et le samedi matin : **« Approfondir »**. Le dimanche matin : **« Simulation dentaire » à 09:20** puis **« Réexpliquer » à 10:20**. Le samedi à 16:00 : **« Cartes d'erreurs de la semaine »**. Le détail est dans `methode.md` — et il a changé, ne te fie pas à une version plus ancienne.
