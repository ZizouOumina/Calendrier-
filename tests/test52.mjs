...
console.log('\n== 171) Activer : un événement par bloc, aujourd\'hui (restants) et demain ==');
{
  ...
  /* 43 → 41 depuis que le bloc « Cours » n'est plus pousse dans l'agenda : les vrais cours
     ...
     perso 6 », et son coucher reste a 21:55.
  ...
  ok(!!coucher && coucher.input.summary === '🦇 Coucher' && coucher.input.startTime === '2026-09-29T21:55:00+02:00' && coucher.input.overrideReminders[0].minutes === 30 && coucher.input.availability === 'AVAILABILITY_FREE' && /Écran off/.test(coucher.input.description), 'Coucher 21:55 (même titre que ton agenda), rappel 30 min, écran off en description, n\'occupe pas l\'agenda');
