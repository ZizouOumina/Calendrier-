...
console.log('\n== 82) Vue mois : totaux, pastilles par type, navigation ==');
{
  ...
  ok(/Révision3h/.test(v.tuiles[1]) && /Espagnol30min/.test(v.tuiles[2]) && /Projetsperso1h30/.test(v.tuiles[3]) && /Blocs5/.test(v.tuiles[4]), 'répartition par type, espagnol à part : ' + v.tuiles.slice(1,5).join(' '));
