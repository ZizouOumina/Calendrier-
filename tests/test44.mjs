...
console.log('\n== 105) Charge restante : cible hebdo moins le fait depuis lundi ==');
{
  ...
  ok(/11,8 h de projets sur 15,8/.test(t), '15,8 − 4 = 11,8 h de projets');
  ok(/5 jours/.test(t), 'mercredi → dimanche : 5 jours');
  ok(/~6,6 h\/jour/.test(t), '(21,1 + 11,8) / 5 = 6,6 h/jour');
  await ctx.close();
}
...
for(const [nom, quand, rev, proj] of [['mercredi','2026-09-02T10:00:00+02:00','4,4','2,6'],['vendredi','2026-09-04T10:00:00+02:00','3,5','1,8'],['samedi','2026-09-05T10:00:00+02:00','4,4','2,8'],['dimanche','2026-09-06T10:00:00+02:00','3,5','0,9']]){
